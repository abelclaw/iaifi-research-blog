...
The **Upsilon (Υ)** is a particle made of a bottom quark and its antimatter partner — a fleeting bundle that forms from the raw energy of collisions and quickly decays into two muons. Physicists have studied it for decades in clean, uncrowded conditions. But when an Upsilon forms *within* a roiling jet of other particles — surrounded rather than isolated — its signal gets drowned out.

That "anti-isolated" scenario is exactly what a team from MIT and Lawrence Berkeley National Laboratory tackled. Nobody had ever successfully pulled such a signal out of real collider data before; the backgrounds are simply too overwhelming for traditional methods.

Using machine learning-based anomaly detection applied to publicly available CMS Open Data, the team transformed a nearly invisible hint into a clear discovery. The signal jumped from a barely perceptible 1.6σ hint to a 6.4σ detection. In physics, **sigma (σ)** measures statistical confidence: 5σ is the conventional discovery threshold, meaning the chance of a random fluctuation mimicking the signal is less than one in a million. This result clears that bar.
...
This cut dramatically suppresses the signal. Without any cuts, Upsilons shine out at 28σ — easy to see. With anti-isolation imposed, the **dimuon mass spectrum** (a plot of how many muon pairs appear at each combined mass, where a real particle shows up as a bump at its known mass) yields a barely perceptible 1.6σ bump. Two dominant backgrounds conspire to bury the Upsilon's characteristic peaks near 9–10 GeV: uncorrelated hadron decays and **Drell-Yan production**, a process in which a virtual photon briefly materializes and decays into a muon pair, producing a smoothly falling background.

To fight back, the researchers deployed **CATHODE** (Classifying Anomalies THrough Outer Density Estimation), an anomaly detection technique that requires no prior knowledge of what the signal looks like. The strategy:
...
4. **Build an anomaly score** comparing actual data to the predicted background — events that don't look like background light up as anomalous
...
The payoff is striking. After applying the learned anomaly score, the Upsilon signal jumps from 1.6σ to 6.4σ. The team also compared two ways of using the anomaly score: a simple **cut-and-count** (keeping only events above a chosen threshold) versus **likelihood-ratio reweighting**, which uses the full continuous distribution of anomaly scores rather than drawing a hard cutoff. The reweighting approach consistently outperformed cuts — a finding that points toward better strategies for future searches.

![Figure 3](/iaifi-research-blog/figures/2502_14036/figure_2.png)

## Why It Matters

This study matters on two levels. For particle physics: anti-isolated **quarkonia** — heavy particles made of a quark and its antimatter partner — probe **QCD fragmentation**, the process by which collision energy gradually congeals into massive bound particles, something like cooling steam condensing into water droplets. Understanding how Upsilons form within jets tests the boundary between perturbative QCD (where the underlying math is tractable) and non-perturbative physics (where it isn't). These measurements set the stage for systematic studies of bottomonium-in-jets that could sharpen fragmentation models, just as earlier charmonium measurements did.

The broader significance is methodological. Anomaly detection at the LHC has been demonstrated on synthetic benchmarks and applied by CMS and ATLAS to search for new physics — but with no significant excesses found yet. A previous open data study rediscovered the top quark, but in already-known signal regions.

This paper is different: it finds a real signal in real data in a region of **phase space** (the full range of particle configurations and energies an experiment can probe) that nobody had examined before, using methods that require no signal simulation. That's exactly the scenario anomaly detection was designed for. By publishing a curated benchmark dataset alongside their analysis code, the authors have handed the broader ML community a concrete, real-world testbed for developing the next generation of search algorithms.

> **Bottom Line:** By pulling a 6.4σ Upsilon signal out of anti-isolated backgrounds that buried it at 1.6σ, this study proves that ML anomaly detection isn't just a theoretical promise — it's a working tool for discovering new physics in collider data.

<div style="margin-top:2rem;"><h2 style="font-size:1.5rem;font-weight:700;margin-bottom:1rem;">IAIFI Research Highlights</h2>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">This work directly applies machine learning anomaly detection — a technique developed in the AI community — to a genuine open problem in experimental particle physics, demonstrating that AI tools can find real signals in regions of phase space inaccessible to traditional analysis.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The study validates CATHODE-style density estimation on real, messy experimental data and shows that likelihood-ratio reweighting outperforms cut-based anomaly score usage, providing concrete guidance for future algorithm development.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">This is the first successful observation of anti-isolated Υ → μ⁺μ⁻ decays at the LHC, opening a new avenue to study QCD bottomonium fragmentation inside jets and probing the nonperturbative regime of the strong force.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future work could apply these methods to search for genuinely unknown resonances in anti-isolated channels; the published CMS Open Data benchmark will enable community-wide development of anomaly detection tools. The paper is available at arXiv:2501.01496.</span></div></div>
</div>
