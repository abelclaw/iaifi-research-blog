...
- /iaifi-research-blog/figures/2305_13780/figure_2.png
- /iaifi-research-blog/figures/2305_13780/figure_3.png
- /iaifi-research-blog/figures/2305_13780/figure_3.png
...
Imagine trying to hear a whisper from a billion light-years away — through a wall of thundering noise. That's essentially what LIGO does every time it listens for gravitational waves, the faint ripples in spacetime produced when black holes collide or neutron stars merge. To catch those whispers, LIGO's detectors must operate at the very edge of what physics permits.

One of LIGO's most powerful tools is **quantum squeezing** — a technique that exploits quantum mechanics to sharpen measurements. Quantum mechanics places a fundamental noise floor on any measurement, a limit you can't beat by building better equipment alone. Squeezing finds a loophole: by deliberately making one aspect of a light beam noisier, you can make another aspect quieter — and it's the quieter one that LIGO needs.

During LIGO's third observing run (O3), squeezing cut quantum noise by up to 3.2 dB — a meaningful gain in a world where every fraction of a decibel matters. But the squeezer is notoriously finicky, and keeping it performing at its best over months-long observing runs is an unsolved problem.

A team of researchers from MIT and IAIFI used machine learning to predict squeezing performance from environmental sensor data — a critical first step toward building AI systems that can automatically tune these quantum instruments in real time.
...
LIGO's squeezed light comes from an **optical parametric oscillator (OPO)**, a specialized crystal device that produces pairs of light particles with linked quantum properties — the raw ingredient for squeezing. The squeezing level that actually reaches the interferometer — the measurement cavity where gravitational waves are detected — depends on a cascade of factors: crystal temperature, pump power, mirror alignment, ground motion, thermal drifts, and dozens more.
...
Once trained, the models weren't black boxes. The team performed **sensitivity analysis** — systematically varying each input to measure its effect on the output — to understand which factors drove predictions most strongly. This transformed the model from a predictor into a diagnostic tool: an AI that can tell engineers which factors are degrading squeezing right now, and by how much.

![Figure 2](/iaifi-research-blog/figures/2305_13780/figure_1.png)

## Why It Matters

This work sits at a compelling intersection: the practical engineering of quantum instruments and the ambitions of next-generation gravitational-wave astronomy. Future detectors like Einstein Telescope and Cosmic Explorer are designed to achieve up to 10 dB of squeezing. The light-loss fluctuations that explain O3's variability — extrapolated to a 10 dB source — would drag performance below 6 dB. That's not a minor inconvenience; it's a fundamental barrier to the science these detectors are built to do.

![Figure 3](/iaifi-research-blog/figures/2305_13780/figure_2.png)

A self-correcting AI control system for quantum instruments is the compelling frontier here. This paper demonstrates the sensing side — predicting squeezing from auxiliary data. The next step is actuation: having the model not just watch, but intervene, adjusting squeezer parameters to push performance back toward optimum.

That's a harder problem — real-time control with physical consequences — but this work establishes the foundation. The implications reach beyond gravitational-wave astronomy: squeezed light is used broadly in quantum sensing, and maintaining quantum performance gains under real-world operating conditions is a universal challenge.

> **Bottom Line:** By training neural networks to predict LIGO's quantum squeezing performance from environmental sensors, this team built a diagnostic AI that pinpoints the sources of noise degradation — laying essential groundwork for the AI-controlled quantum instruments that next-generation detectors will require.

<div style="margin-top:2rem;"><h2 style="font-size:1.5rem;font-weight:700;margin-bottom:1rem;">IAIFI Research Highlights</h2>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">This work fuses quantum optics engineering with modern machine learning, applying neural networks and genetic algorithms to optimize one of the most sensitive quantum instruments ever built — a gravitational-wave detector operating at the quantum noise limit.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The combination of neural network prediction with genetic algorithm-based feature selection and post-hoc sensitivity analysis demonstrates how interpretable ML can serve as a scientific diagnostic tool — not just a black-box predictor — in high-stakes experimental settings.</span></div></div>
