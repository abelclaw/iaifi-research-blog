...
- **Interdisciplinary Research Achievement:** This work sits squarely at the intersection of simulation-based inference and observational astrophysics. The authors show that neural likelihood-ratio estimators trained on physically motivated forward models can extract meaningful dark matter constraints from real telescope data.

- **Impact on Artificial Intelligence:** The study pushes simulation-based inference forward by rigorously evaluating model calibration and handling distribution shift between training simulations and real observations, a general challenge relevant far beyond astrophysics.

- **Impact on Fundamental Interactions:** By measuring subhalo density slopes steeper than cold dark matter predictions in real HST observations, the results add to a growing body of evidence that demands careful scrutiny of dark matter models on subgalactic scales.

- **Outlook and References:** With Euclid and Rubin set to deliver thousands of new lens systems, this pipeline is positioned to provide the first statistically powerful population-level constraints on dark matter's small-scale structure; the paper is available at [arXiv:2308.09739](https://arxiv.org/abs/2308.09739).
