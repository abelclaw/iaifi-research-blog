...
The gradient dynamics confirm this. With KL-based losses, training signals show violent spikes early in optimization — a sign of an unstable loss landscape. The bounded divergences train smoothly. The choice of loss function shapes the entire training trajectory.
