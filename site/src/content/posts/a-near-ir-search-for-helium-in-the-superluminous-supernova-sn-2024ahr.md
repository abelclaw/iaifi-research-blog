...
A team led by Harsh Kumar and Edo Berger at Harvard's Center for Astrophysics tackled that question head-on with SN 2024ahr — a nearby superluminous supernova that offered a rare, high-quality look in the near-infrared, the spectral window just beyond what human eyes can see. That window, it turns out, is where the helium question can finally be answered cleanly.
...
The challenge with detecting helium in supernovae has always been contamination. In visible light, helium's spectral lines sit uncomfortably close to signals from calcium, sodium, and carbon — all generating their own broad features. In a superluminous supernova, the **ejecta** (the material blasted outward by the explosion) move so fast that every spectral line smears into a wide blur, making optical helium detections essentially unreliable.

The solution is to look in the near-infrared, specifically at a helium emission line at **2.058 micrometers** (He I λ2.058 μm). This feature sits in a region largely free of competing signals. Models show it can reveal helium masses as small as 0.1 solar masses — making it the cleanest diagnostic available.

![Figure 1](/iaifi-research-blog/figures/2501_01485/figure_1.png)

SN 2024ahr made an ideal target because of its low **redshift** — a measure of a galaxy's recession velocity, and thus a proxy for distance. At z = 0.0861, the light traveled roughly 1.1 billion years to reach us, which for a superluminous supernova counts as nearby. That proximity translates directly into signal strength.

The team obtained a near-infrared spectrum ~43 rest-frame days after peak brightness, using the NIRES spectrograph on the Keck I telescope in Hawaii. Timing matters: observe too early and the expanding gas cloud is still **optically thick**, trapping light and burying the helium signal; wait too long and the features fade into noise.

The brightness measurements came from multiple facilities:

- **UV/optical light curves** from Swift, the Las Cumbres Observatory network, and the Zwicky Transient Facility
...
The near-infrared spectrum told the key story. No significant signal appeared at the 2.058 μm helium line. By comparing synthetic spectra modeled with varying helium masses, the team set a conservative upper limit of ~0.05 solar masses — far below the detection threshold of most optical methods. What they *did* find were features of magnesium (Mg I λ1.575 μm) and a cobalt-magnesium blend (Co II λ2.126 μm + Mg II λ2.136 μm), stretched wider by the high ejecta velocities that define SLSNe-I. These are signatures characteristic of Type Ic supernovae.
...
Comparing SN 2024ahr to other SLSNe-I with near-infrared spectroscopy revealed something striking: most previously studied events are *peculiar* — bumpy light curves, unusual spectral features, borderline luminosities. SN 2024ahr, by contrast, is textbook SLSN-I.

That distinction matters. A clean, representative sample is what's needed to statistically measure the Ib-like versus Ic-like fraction. Right now, the field is working with a handful of oddities. The researchers argue forcefully that more near-infrared observations of ordinary, garden-variety superluminous supernovae are essential to make progress.
...
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">While primarily observational, the study depends on automated transient detection pipelines and light-curve fitting frameworks that underpin the machine-learning-driven survey astronomy now discovering hundreds of superluminous supernovae per year.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">Constraining the helium content of a superluminous supernova progenitor to below 0.05 solar masses sharpens our understanding of the mass-stripping mechanisms and evolutionary pathways that govern how the most massive stars end their lives.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Expanding near-infrared spectroscopic coverage to a large, representative sample of SLSNe-I is the critical next step; the full study is available at arXiv:2501.02105.</span></div></div>
</div>
