...
- **Interdisciplinary Research Achievement:** This work sits squarely at the intersection of modern AI architecture and condensed matter physics, showing that transformer self-attention, developed for language, turns out to be a natural framework for quantum correlations between electrons.
- **Impact on Artificial Intelligence:** A single general-purpose self-attention wavefunction architecture generalizes across diverse quantum phases, including topologically nontrivial superconductors, without any problem-specific modifications.
- **Impact on Fundamental Interactions:** For the first time, chiral *p_x ± ip_y* superconductivity with its characteristic reversed odd-even binding energy signature has been obtained variationally from an unbiased neural network, surpassing BCS mean-field theory in the strong-coupling regime.
- **Outlook and References:** Future work targets strongly correlated electron materials where unconventional superconductivity remains poorly understood. The full paper is available at [arXiv:2509.03683](https://arxiv.org/abs/2509.03683).
