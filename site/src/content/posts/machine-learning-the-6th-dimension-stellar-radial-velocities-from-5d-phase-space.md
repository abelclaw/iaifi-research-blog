...
Spectroscopy measures how starlight shifts in color depending on whether a star is moving toward us or away — the same principle behind the rising-and-falling pitch of a passing ambulance siren, but applied to light instead of sound. In the early *Gaia* data releases, fewer than 1% of observed stars had this crucial measurement.

A team of researchers from Princeton, Harvard, New York University, and the University of Oregon found a clever solution: train a neural network to infer the missing sixth dimension from the five that *Gaia* already provides.
...
The results are striking. The network successfully recovers full **velocity distributions** — not just rough averages, but the detailed statistical shapes of how stars move in each direction — for stars within roughly 5 kiloparsecs (about 16,000 light-years) of the Sun. It also captures the correlations between velocity components, which encode the dynamical structure of the galaxy.

![Figure 2](/iaifi-research-blog/figures/2103_14039/figure_2.png)

Perhaps most impressive is the network's performance on **kinematic substructure** — groupings of stars that share distinctive movement patterns, invisible to ordinary sky searches. Gaia Enceladus stars are spatially spread out; you can't find them by position alone. Their signature lives purely in velocity space.

Even when these stars represent only about 0.5% of the training set, the network accurately reconstructs their distinct velocity distribution. That's a powerful demonstration that machine learning can contribute meaningfully to the search for the Milky Way's ancient merger history.

![Figure 3](/iaifi-research-blog/figures/2103_14039/figure_3.png)

This work sits at a precise moment in *Gaia*'s development. Future data releases will steadily expand the number of stars with spectroscopic measurements, but that process takes years. In the interim, neural network inference provides a statistically rigorous way to extract more science from data already in hand — working alongside spectroscopic surveys like APOGEE, GALAH, and LAMOST, not replacing them.

The broader lesson matters beyond *Gaia*. Any time a dataset is systematically missing one kind of measurement, correlated variables may let a well-designed network fill the gap — with calibrated uncertainty rather than false confidence. That's a template applicable across astronomy and beyond.

> **Bottom Line:** By training on the known correlations in stellar kinematics, this team predicts *Gaia*'s missing sixth dimension — line-of-sight velocity — for millions of stars, complete with honest uncertainty estimates, recovering kinematic substructures invisible to purely geometric searches.

---

<div style="margin-top:2rem;"><h2 style="font-size:1.5rem;font-weight:700;margin-bottom:1rem;">IAIFI Research Highlights</h2>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">This work applies modern deep learning architectures to a core challenge in observational astrophysics, turning incomplete phase-space data into statistically rigorous velocity predictions that directly serve galactic dynamics research.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The compound dual-output network — simultaneously predicting a value and its own uncertainty — demonstrates a practical architecture for uncertainty-aware regression in scientific domains where calibrated confidence matters as much as the prediction itself.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">Recovering full 6D phase-space information for millions of stars dramatically expands the usable dataset for measuring the Milky Way's gravitational potential, mapping dark matter density, and identifying remnants of ancient galaxy mergers like Gaia Enceladus.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future work will apply this approach to real *Gaia* data releases and extend coverage as spectroscopic surveys expand the training set; the method and code are available on GitHub, and the paper is archived at arXiv:2107.04503.</span></div></div>
</div>
