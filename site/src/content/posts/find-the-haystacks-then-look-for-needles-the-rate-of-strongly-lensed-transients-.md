...
Imagine searching for a handful of needles scattered across every haystack in North America. That's roughly the challenge astronomers face when hunting for **gravitationally lensed supernovae** — exploding stars whose light has been bent and split into multiple images by a foreground galaxy's gravity. These events are so rare and so scientifically valuable that finding even one could help resolve one of the deepest mysteries in modern physics.

The mystery is the **Hubble tension**: a stubborn disagreement between two independent measurements of how fast the universe is expanding. Local measurements using Cepheid stars and Type Ia supernovae give about 73 km/s/Mpc — meaning the universe expands 73 kilometers per second faster for every 3.26 million light-years of distance — while measurements from the **cosmic microwave background** (the faint afterglow of the Big Bang, observed in light that traveled 13.8 billion years to reach us) land at 67 km/s/Mpc. That 9% gap shouldn't exist if our cosmological model is complete, and closing it requires an independent measurement that relies on neither method.
...
The team built a detailed simulation pipeline to model the full population of discoverable **gravitationally lensed supernovae (glSNe)**. The simulation incorporates realistic supernova rates, galaxy distributions, lens mass profiles, and the detection characteristics of both the **Vera C. Rubin Observatory's LSST** (Legacy Survey of Space and Time) and the **Euclid space telescope**.
...
The results are striking. LSST should discover roughly **88 glSNe per year**, with ~30% uncertainty driven mostly by assumptions about unlensed supernova rates. Of those, **54% will have a multiply-imaged host galaxy** — the kind that helps astronomers reconstruct lens geometry and enables precise H₀ measurements. That fraction stays remarkably stable across different modeling assumptions.

More importantly, **20 glSNe per year** will occur in systems Euclid could plausibly have already catalogued as galaxy-galaxy lenses. These systems carry a built-in advantage: they tend to have longer time delays, making delay measurements more precise.

![Figure 4](/iaifi-research-blog/figures/2407_04080/figure_2.png)

The team then defined a **golden sample** — events best suited for cosmology: Type Ia supernovae with time delays longer than 10 days, image separations larger than 0.8 arcseconds (1/3600 of a degree, far beyond naked-eye resolution), and a multiply-imaged host. For this golden sample, an extraordinary **91% occur in systems already discoverable by Euclid** as galaxy-galaxy lenses.

## Why It Matters

This result reframes how astronomers should approach the next decade of lensed-supernova science. Rather than building pipelines to sift millions of nightly transient alerts — a problem plagued by contamination from ordinary supernovae, **active galactic nuclei** (supermassive black holes at galaxy centers that flare brightly), and variable stars — observatories could instead monitor a few thousand known lens systems. The signal-to-noise problem collapses dramatically.

The cosmological stakes are real. Each precisely measured time delay provides an independent H₀ measurement. With LSST operating for a decade, accumulating enough golden-sample events for percent-level precision on H₀ becomes plausible — potentially enough to determine whether the Hubble tension reflects systematic errors or genuinely new physics beyond the standard cosmological model. Pre-identified lens catalogs make that accumulation tractable in a way it simply wasn't before.

![Figure 5](/iaifi-research-blog/figures/2407_04080/figure_3.png)

Open questions remain. The ~30% rate uncertainty reflects genuine gaps in knowledge: how supernova rates evolve with **redshift** (a proxy for distance and look-back time, indicating how much the universe has expanded since the light was emitted), how lens galaxy populations change over cosmic time, and how well Euclid's actual performance matches simulations. As Euclid delivers its first lens catalogs and LSST comes online, these predictions will be tested in real time.
...
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">This work bridges gravitational astrophysics and large-scale survey science, developing simulation frameworks that connect lens population statistics to observational discovery strategies — the kind of cross-disciplinary modeling central to IAIFI's mission.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The research directly informs how AI-driven transient classifiers for LSST should be designed, showing that targeted monitoring of known lens systems dramatically reduces the false-positive burden compared to blind all-sky searches.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">By quantifying the expected yield of cosmologically golden lensed supernovae, this work lays the groundwork for independent H₀ measurements that could resolve the Hubble tension and reveal physics beyond the standard cosmological model.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">With Euclid's lens catalogs now coming online and LSST first light approaching, these predictions will be tested within years; the paper is available at arXiv:2407.07621.</span></div></div>
</div>
