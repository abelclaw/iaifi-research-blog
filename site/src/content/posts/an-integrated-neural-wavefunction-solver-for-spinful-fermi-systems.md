...
Imagine tracking a flock of birds where every bird's movement depends on every other bird's simultaneously — and each bird also has a hidden internal state that shapes how it responds to its neighbors. Now scale that to trillions of electrons. Each electron has both a position in space and a quantum property called **spin** — a built-in compass needle that can point up, down, or anywhere in between. That's the challenge of **quantum many-body physics** — how enormous numbers of quantum particles interact — and it's one of the hardest computational problems in science.

Neural networks have made stunning progress on the simpler version: finding the **quantum ground state** — the lowest-energy arrangement — of electrons described purely by their positions. But the real world is messier. Most interesting quantum materials — magnets, superconductors, topological insulators — owe their exotic properties to the interplay between *where* electrons sit and *what their spins are doing*. Neural network solvers have largely failed when spin enters the picture.

A team of physicists at MIT has built a method that tackles both challenges: an integrated solver handling position *and* spin simultaneously, using a neural network architecture borrowed from AI language models, paired with a smarter search procedure that explores spin arrangements as well as electron positions.
...
Without spin updates, the sampler gets stuck in configurations with the wrong spin arrangement, causing slow convergence or outright failure to find the true ground state. With them, the method explores the full configuration space efficiently.

The wavefunction is represented by a **transformer neural network** — the same architecture powering large language models like ChatGPT, repurposed for quantum physics. The transformer takes continuous positions and discrete spin labels of all electrons simultaneously. Its **attention mechanisms** — which weigh relationships between all inputs at once — capture correlations between electrons whether those correlations are position-mediated, spin-mediated, or both.

The authors prove mathematically that this architecture is a **universal approximator** of spinful generalized orbitals: it can represent any physically valid fermionic wavefunction, a significant theoretical guarantee. **Fermionic antisymmetry** — the Pauli exclusion principle, which forbids two fermions from occupying the same quantum state — is enforced by taking determinants of the neural network outputs, following earlier neural wavefunction networks (FermiNet and Psiformer) but extended to the spinful setting.

![Figure 2](/iaifi-research-blog/figures/2510_18621/figure_1.png)

## Why It Matters

The team validated their solver on three increasingly complex physical problems.

First: a **two-dimensional electron gas with Rashba spin-orbit coupling**, where electrons moving through a material with broken mirror symmetry experience an effective magnetic field that locks spin to momentum — a key ingredient in topological insulators and certain superconductors.
...
This work also demonstrates that transformer architectures aren't just for language and images — they provide a provably expressive framework for quantum states with mixed continuous and discrete inputs. The ideas extend naturally to any quantum system with internal degrees of freedom: nuclear spins, orbital quantum numbers, valley pseudospin in 2D materials, or color charge in quark systems.
...
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">This work marries transformer architectures from modern machine learning with the variational Monte Carlo framework of quantum physics, demonstrating that neural network tools developed for language and vision can be rigorously adapted to solve fundamental condensed matter problems.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The paper proves that transformers with mixed continuous-discrete inputs are universal approximators for spinful fermionic wavefunctions, establishing a theoretical foundation for using attention-based architectures in quantum many-body machine learning.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">The solver captures correlated magnetic and spin-orbit phenomena in two-dimensional systems — including moiré antiferromagnetism and noncollinear spin textures — directly from first principles, without prior assumptions about ground state structure.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future work targeting three-dimensional materials and larger system sizes could make this a standard tool for predicting properties of correlated quantum materials; the paper is available at arXiv:2506.XXXXX (Avdoshkin, Geier, Fu, MIT Department of Physics).</span></div></div>
</div>
