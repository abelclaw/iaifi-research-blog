...
Imagine watching a fireworks show where one explosive launches two distinct bursts of light, separated by nearly three months, each blazing as bright as billions of stars. That's what astronomers saw when SN 2019stc ignited in late 2019, a stellar death so strange it defied every standard explanation.
...
> **Key Insight:** SN 2019stc is a cosmic Rosetta Stone. A single supernova simultaneously displays features of two entirely different explosion classes, suggesting that the boundary between ordinary stripped-core supernovae and their ultra-luminous cousins is far blurrier than astronomers assumed.
...
The better solution involved a **magnetar engine**, a newly-formed neutron star spinning hundreds of times per second, its rapid rotation bleeding energy into surrounding gas like an electromagnetic dynamo. Fitting the first peak with a combined magnetar-plus-nickel model produced far more reasonable numbers:
