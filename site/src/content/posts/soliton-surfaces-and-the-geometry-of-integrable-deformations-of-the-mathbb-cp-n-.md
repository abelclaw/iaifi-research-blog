---
abstract: The $\mathbb{CP}^{N-1}$ model is an analytically tractable $2d$ quantum
  field theory which shares several properties with $4d$ Yang-Mills theory. By virtue
  of its classical integrability, this model also admits a family of integrable higher-spin
  auxiliary field deformations, including the $T \overline{T}$ deformation as a special
  case. We study the $\mathbb{CP}^{N-1}$ model and its deformations from a geometrical
  perspective, constructing their soliton surfaces and recasting physical properties
  of these theories as statements about surface geometry. We examine how the $T \overline{T}$
  flow affects the unit constraint in the $\mathbb{CP}^{N-1}$ model and prove that
  any solution of this theory with vanishing energy-momentum tensor remains a solution
  under analytic stress tensor deformations -- an argument that extends to generic
  dimensions and instanton-like solutions in stress tensor flows including the non-analytic,
  $2d$, root-$T \overline{T}$ case and classes of higher-spin, Smirnov-Zamolodchikov-type,
  deformations. Finally, we give two geometric interpretations for general $T \overline{T}$-like
  deformations of symmetric space sigma models, showing that such flows can be viewed
  as coupling the undeformed theory to a unit-determinant field-dependent metric,
  or using a particular choice of moving frame on the soliton surface.
arxivId: '2509.05081'
arxivUrl: https://arxiv.org/abs/2509.05081
authors:
- Christian Ferko
- Michele Galli
- Zejun Huang
...
figures: []
pdfUrl: https://arxiv.org/pdf/2509.05081v1
published: '2025-09-05T13:20:48+00:00'
theme: Theoretical Physics
title: Soliton Surfaces and the Geometry of Integrable Deformations of the $\mathbb{CP}^{N-1}$
  Model
wordCount: 1034
---
...
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">This work deploys advanced differential geometry (soliton surfaces, moving frames, Sym-Tafel immersions) as a mathematical tool for understanding quantum field theories central to fundamental physics, building a concrete bridge between pure mathematics and theoretical particle physics.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The geometric framework developed here, translating dynamical systems into geometric objects via symmetric spaces and Lie algebras, reflects the same mathematical structures underlying equivariant neural networks and geometric deep learning, active research areas at IAIFI.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">The paper proves a general theorem that instanton solutions survive analytic stress tensor deformations intact, advancing our understanding of non-perturbative physics in deformed quantum field theories that serve as tractable analogues of Yang-Mills theory and QCD.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future directions include extending the soliton surface analysis to quantum-level phenomena and exploring connections to holography and string theory; the full paper is available at [arXiv:2509.05081](https://arxiv.org/abs/2509.05081).</span></div></div>
</div>
