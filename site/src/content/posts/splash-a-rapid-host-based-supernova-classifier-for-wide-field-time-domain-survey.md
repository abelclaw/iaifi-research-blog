...
The results are competitive with state-of-the-art photometric classifiers: **76% binary accuracy** and a **69% F1-score** — a combined measure of how well the classifier avoids both false alarms and missed detections. Crucially, SPLASH can tune its confidence threshold to return highly pure samples. If you only want confident Type Ia candidates for a cosmology study, you can dial up the purity at the cost of completeness — flexibility that matters enormously for real observational programs.
...
But SPLASH's value extends beyond speed. Because it infers physical host properties as an intermediate step, it doubles as a **selection tool for probing stellar demographics**. Want a sample of supernovae in low-mass, high-star-formation-rate galaxies? SPLASH can filter for that.

This makes it useful not just for triggering follow-up observations but for population-level studies of how stellar death rates vary with galactic environment — a window into the life cycles of stars across cosmic time. As LSST's dataset grows over its ten-year run, tools like SPLASH will be essential for structuring massive catalogs into scientifically meaningful subpopulations.

![Figure 3](/iaifi-research-blog/figures/2506_00121/figure_3.png)

> **Bottom Line:** SPLASH classifies 500 supernovae per second using only host galaxy photometry, achieving 76% accuracy — and it does so at the moment of detection, making it an ideal first-response tool for the data tsunami that LSST is about to unleash.

<div style="margin-top:2rem;"><h2 style="font-size:1.5rem;font-weight:700;margin-bottom:1rem;">IAIFI Research Highlights</h2>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">SPLASH bridges astrophysics and machine learning by using deep neural networks to extract galaxy physics from photometry, then feeding those physical priors into a downstream classifier — a pipeline architecture that mirrors the real causal chain from stellar environment to stellar death.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The two-stage approach — inferring interpretable physical properties before classification rather than classifying from raw photometry — demonstrates how embedding domain knowledge into an ML pipeline can yield both better generalization and a scientifically useful intermediate product.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">By enabling rapid, environment-aware classification of millions of supernovae, SPLASH accelerates discovery across multiple fronts: constraining progenitor physics, measuring the cosmic equation of state through Type Ia cosmology, and mapping how star formation history drives transient demographics.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future work will incorporate photometric light-curve data alongside host properties to push accuracy further, and the pipeline is designed to scale seamlessly with LSST's alert stream from day one; see arXiv:2506.XXXXX (Boesky et al. 2025).</span></div></div>
</div>
