...
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future work will focus on tightening the horizon dependence, extending results to richer feedback models, and closing the gap between theory and computationally practical implementations; the paper is available at arXiv:2507.17815.</span></div></div>
</div>
