...
![Figure 2](/iaifi-research-blog/figures/2210_15789/figure_2.png)
...
![Figure 3](/iaifi-research-blog/figures/2210_15789/figure_3.png)
...
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future work could extend these results to fermionic theories and multi-hadron systems, where the Parisi-Lepage problem is most severe. The paper is available at [arXiv:2210.15789](https://arxiv.org/abs/2210.15789) by Cagin Yunus and William Detmold.</span></div></div>
</div>
