...
- **Interdisciplinary Research Achievement:** This paper applies random forest machine learning to astrophysical transient classification, training on real observational data to tackle a core challenge in time-domain astronomy at the intersection of AI and black hole physics.

- **Impact on Artificial Intelligence:** FLEET shows that ensemble ML methods trained on imbalanced, real-world datasets (rather than simulations) can achieve classification purity nearly two orders of magnitude better than random selection.

- **Impact on Fundamental Interactions:** Efficient TDE identification at scale accelerates the statistical study of supermassive black hole demographics, accretion physics, and stellar dynamics at galactic centers.

- **Outlook and References:** With Rubin poised to deliver a torrent of transient alerts in the mid-2020s, FLEET is positioned to become a real-time discovery engine; the full paper and open-source code are available at [arXiv:2210.10810](https://arxiv.org/abs/2210.10810) and https://github.com/gmzsebastian/FLEET.
