...
**Step 3: Nearest-neighbor search.** The similarity engine uses **ANNOY** (Approximate Nearest Neighbors Oh Yeah), a Spotify-developed algorithm that indexes a vector space using **locality-sensitive hashing** — grouping similar objects into shared buckets so close matches can be found quickly without brute-force comparison. Users can search by light curve alone, by host galaxy alone, or by both, with a tunable weighting term.
...
The team plans to extend the feature set beyond ZTF's current filters and to test performance on partial-phase and low-cadence light curves — challenges that will intensify as Rubin data arrives.

> **Bottom Line:** reLAISS turns the coming supernova data deluge into a navigable map — a nearest-neighbor search engine for stellar explosions that's fast, flexible, and physically interpretable, arriving just in time for the era of million-event-per-year astronomy.

<div style="margin-top:2rem;"><h2 style="font-size:1.5rem;font-weight:700;margin-bottom:1rem;">IAIFI Research Highlights</h2>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">reLAISS applies machine learning nearest-neighbor search — originally developed for recommendation systems — to astrophysical transient discovery, bridging scalable AI indexing with the physics of stellar explosions and their galactic environments.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The package demonstrates how approximate nearest-neighbor algorithms combined with uncertainty-aware Monte Carlo resampling enable robust, interpretable similarity search at scale across noisy, heterogeneous scientific datasets.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">By jointly modeling supernova light curve morphology and host galaxy stellar populations, reLAISS enables discovery of rare or anomalous explosion mechanisms that could reveal progenitor physics beyond the standard core-collapse and thermonuclear channels.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">The reLAISS package is pip-installable with a 20,000-event reference set and tutorials; future work will extend its reach to Rubin/LSST cadences and additional photometric passbands (Reynolds, Gagliano & Villar 2025, arXiv).</span></div></div>
</div>
