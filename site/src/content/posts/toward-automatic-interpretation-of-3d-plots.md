...
- **Interdisciplinary Research Achievement:** This work connects computer vision and scientific data extraction, developing tools that could automate the interpretation of 3D figures across physics, chemistry, and other quantitative sciences.
- **Impact on Artificial Intelligence:** The SurfaceGrid dataset (98,600 synthetic images with paired depth maps) and the trained encoder-decoder model establish a new benchmark for the underexplored problem of 3D chart interpretation.
- **Impact on Fundamental Interactions:** Automated 3D plot reading could speed up literature discovery in physics and related fields, letting researchers search scientific databases by data content rather than keywords alone.
- **Outlook and References:** Future work will extend the pipeline to handle axis calibration, deprojection, and real-world published figures. The paper is available at [arXiv:2106.07627](https://arxiv.org/abs/2106.07627).
