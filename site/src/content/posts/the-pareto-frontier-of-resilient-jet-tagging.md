...
Over the past decade, physicists have turned to increasingly powerful AI designs claiming ever higher scores on standard benchmarks. But a new [study](https://arxiv.org/abs/2509.19431) from IAIFI-affiliated researchers asks a disquieting question: what if chasing higher test scores is making our physics analyses *worse*?
