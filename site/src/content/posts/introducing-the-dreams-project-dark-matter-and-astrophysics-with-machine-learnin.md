...
- **Interdisciplinary Research Achievement:** DREAMS sits at the intersection of particle physics theory, cosmological simulation, and modern machine learning, building training datasets specifically designed for neural network inference of fundamental dark matter properties from astrophysical observables.

- **Impact on Artificial Intelligence:** Emulators and CNNs trained on diverse, multi-parameter simulation suites can disentangle correlated physical effects, a template for simulation-based inference in any domain where ground truth is expensive to compute.

- **Impact on Fundamental Interactions:** By varying dark matter particle mass alongside baryonic feedback across 2,048 hydrodynamic simulations, DREAMS provides the theoretical infrastructure needed to turn observations of dwarf galaxies and satellite populations into genuine constraints on dark matter's particle nature.

- **Outlook and References:** Future DREAMS suites will expand to cold dark matter, self-interacting models, and galaxy cluster targets, with public data releases planned; the paper is available at [arXiv:2405.00766](https://arxiv.org/abs/2405.00766).
