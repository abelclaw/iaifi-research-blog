...
When networks trained only on the harder composite tasks, they failed — or learned agonizingly slowly. When they trained on the full distribution, including primitive tasks, performance soared. The broad training acted as an automatic **curriculum** — a structured sequence moving from simpler to harder problems — letting the network build foundational skills first, then use them as scaffolding for compositional ones.
...
The researchers then investigated a technique to actively reshape how skills are stored: a **group lasso regularization** objective applied during additional training. This mathematical penalty pushes the network to consolidate each skill into as few neurons as possible, forcing spread-out representations to reorganize into something more modular. After regularization, pruning became significantly more effective — target skills were retained while unwanted ones were successfully unlearned.
...
Pruning after group lasso regularization consistently outperformed distillation for producing compact, specialized models. This is a counterintuitive result: distillation is the dominant approach for model compression, but it doesn't explicitly disentangle skills, making selective preservation difficult.

![Figure 3](/iaifi-research-blog/figures/2505_15811/figure_3.png)

## Why It Matters

The implications run in two directions. For AI safety, the news is both sobering and cautiously hopeful. The sobering part: you probably can't skip broad training if you want state-of-the-art performance on complex tasks — hierarchical skill dependencies mean the general training is doing genuine work. The hopeful part: once you have a powerful general model, there may be a principled path to extracting a lean, narrow version — one with fewer dangerous capabilities, a smaller computational footprint, and better interpretability.
...
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#f5f5f5;border:1px solid #d4d4d4;"><img src="/iaifi-research-blog/images/logo-fi-black.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#1a1a1a;">Interdisciplinary Research Achievement</strong><br/><span style="color:#374151;">This work applies physicist-style controlled experiments — synthetic tasks with precisely tunable structure — to probe fundamental properties of neural network learning, exemplifying the IAIFI approach of bringing physics thinking to AI science.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#eff6ff;border:1px solid #bfdbfe;"><img src="/iaifi-research-blog/images/logo-ai-blue.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#2c5f8a;">Impact on Artificial Intelligence</strong><br/><span style="color:#374151;">The paper identifies and empirically characterizes two previously underappreciated obstacles to narrow AI creation, and demonstrates that group lasso regularization can reshape skill locality to enable more effective pruning.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#faf5ff;border:1px solid #e9d5ff;"><img src="/iaifi-research-blog/images/logo-fi-purple.svg" alt="" style="width:32px;height:32px;flex-shrink:0;" /><div><strong style="color:#7b2d8e;">Impact on Fundamental Interactions</strong><br/><span style="color:#374151;">Understanding how skills are structured and stored in neural networks advances the theoretical foundations of machine learning, with direct relevance to building safer and more interpretable AI systems for scientific applications.</span></div></div>
<div style="display:flex;gap:0.75rem;align-items:flex-start;padding:1rem;margin-bottom:0.75rem;border-radius:0.5rem;background:#ecfdf5;border:1px solid #a7f3d0;"><div><strong style="color:#059669;">Outlook and References</strong><br/><span style="color:#374151;">Future work should investigate whether hierarchical curriculum effects persist at scale in frontier models and whether regularization-based narrowing can be applied to physics discovery pipelines; the paper appears at NeurIPS 2025 from the Michaud, Parker-Sartori, and Tegmark group at MIT/IAIFI.</span></div></div>
</div>
